 ...
 * 宗门状态服务测试
 */
class SectStatusServiceTest : EntityRelationContext {
    ...
    fun testStatusIsOperational() {
        // Given: 使用默认创建的宗门
        val service = SectStatusService(world)

        // When: 检查宗门状态
        val status = service.checkSectStatus()
    ...
    fun testFinancialSummary() {
        ...
        // When: 获取财务摘要
        val summary = service.getFinancialSummary()
