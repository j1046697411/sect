  ...
  desktop:
    ...
    steps:
      ...
      - name: Upload Artifact
        ...
        with:
          name: desktop-app
          path: composeApp/build/outputs/**/*.dmg
```
...
# 2. 检查是否有编译错误
./gradlew :composeApp:compileJvmDev --info
...
```bash
# 查看详细错误
./gradlew :composeApp:lint --info

# 自动修复
./gradlew :composeApp:lintFix
