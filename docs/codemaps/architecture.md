...
**入口点**: client/src/commonMain/kotlin/cn/jzl/sect/App.kt
...
| client | lko-ecs, lko-ecs-serialization | 应用入口 |
...
- [ECS 架构详解](../technology/ecs-architecture.md)
- [依赖注入](../technology/ecs-architecture.md) - 内部文档
- [游戏需求文档](../requirements/文字游戏需求文档_GRD.md)
