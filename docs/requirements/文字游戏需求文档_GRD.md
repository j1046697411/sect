...
- **丰富的修炼系统**：包含境界提升、功法学习、丹药炼制等多种修炼方式
...
| 优先级 | 功能模块 | 子功能 | 描述 | 依赖项 |
|-------|---------|-------|------|-------|
| **P0-A** | **玩家交互系统** | **菜单导航** | 支持通过菜单进行所有游戏操作 | 无 |
| P0-A | 玩家交互系统 | **状态显示** | 实时显示宗门状态、资源状况、角色信息 | 无 |
| P0-A | **AI角色系统** | **角色层级管理** | 实现掌门→长老→亲传弟子→内门弟子→外门弟子→宗门杂役→凡俗百姓的层级结构 | 无 |
| P0-A | AI角色系统 | **状态管理** | 管理AI角色的状态变化，如成长、衰老、死亡 | 无 |
| P0-A | **宗门管理系统** | **资源管理** | 管理粮食、布料、木材、矿石、灵石等资源的获取、存储、分配和消耗 | 无 |
| P0-A | 宗门管理系统 | **弟子管理** | 管理弟子的招募、培养、分配和晋升 | 无 |
| P0-A | **成长系统** | **修为提升** | 实现角色境界的提升机制 | 无 |
| **P0-B** | 玩家交互系统 | **角色模式选择** | 支持掌门、长老、弟子和观察者四种游戏模式 | 无 |
| P0-B | 玩家交互系统 | 快捷键支持 | 提供常用功能的数字快捷键 | 菜单导航 |
| P0-B | 玩家交互系统 | 事件日志 | 记录游戏事件和操作结果，支持按类型筛选 | 无 |
| P0-B | 玩家交互系统 | 菜单系统 | 提供分层级的操作菜单，支持快捷操作 | 无 |
| P0-B | AI角色系统 | **自主决策** | AI角色能够根据环境和目标进行自主决策 | 状态管理 |
| P0-B | AI角色系统 | 行为执行 | AI角色能够执行各种行为，如修炼、工作、社交等 | 自主决策 |
| P0-B | 宗门管理系统 | **设施管理** | 管理宗门设施的建设、维护和升级 | 资源管理 |
| P0-B | **战斗系统** | **基础战斗机制** | 实现文字描述的回合制战斗 | 无 |
| P0-B | 战斗系统 | 战斗结算 | 处理战斗结果，分配奖励或惩罚 | 基础战斗机制 |
| P0-B | **经济系统** | **双货币体系** | 实现灵石和贡献点的管理 | 无 |
| P0-B | 经济系统 | 资源交易 | 支持与其他宗门进行资源交易 | 双货币体系 |
| P0-B | **地图系统** | **区域管理** | 管理游戏世界的区域划分和状态 | 无 |
| P0-B | 地图系统 | **区域占领** | 支持占领和控制游戏世界中的不同区域 | 区域管理 |
| P0-B | **设施系统** | **设施建设** | 支持建设各种宗门设施 | 资源管理 |
| P0-B | 设施系统 | **设施升级** | 支持设施升级，提升功能和效率 | 设施建设 |
| P0-B | **功法系统** | **功法学习** | 支持角色学习和修炼功法 | 成长系统 |
...
> **验收标准格式**：采用 Given-When-Then 格式定义可测试的验收条件

| 需求ID | 优先级 | 功能模块 | 子功能 | 描述 | 依赖项 | 完成标准 |
|-------|-------|---------|-------|------|-------|---------|
| **RQ-001** | **P0-A** | **玩家交互系统** | **菜单导航** | 支持通过菜单进行所有游戏操作 | 无 | **Given** 游戏已启动<br>**When** 玩家点击任意菜单项<br>**Then** 对应功能界面在 1 秒内显示 |
| RQ-002 | P0-A | 玩家交互系统 | **状态显示** | 实时显示宗门状态、资源状况、角色信息 | 无 | **Given** 游戏运行中<br>**When** 资源或状态发生变化<br>**Then** 界面在 500ms 内更新显示 |
| **RQ-003** | **P0-A** | **AI角色系统** | **角色层级管理** | 实现掌门→长老→亲传弟子→内门弟子→外门弟子→宗门杂役→凡俗百姓的层级结构 | 无 | **Given** 一个新创建的角色<br>**When** 角色被分配职务<br>**Then** 角色层级正确设置，可通过 `position` 组件查询 |
| RQ-004 | P0-A | AI角色系统 | **状态管理** | 管理AI角色的状态变化，如成长、衰老、死亡 | 无 | **Given** 一个年龄为 100 岁的角色<br>**When** 游戏时间推进 1 年<br>**Then** 角色年龄增加 1，状态组件正确更新 |
| **RQ-005** | **P0-A** | **宗门管理系统** | **资源管理** | 管理粮食、布料、木材、矿石、灵石等资源的获取、存储、分配和消耗 | 无 | **Given** 宗门仓库有 1000 灵石<br>**When** 消耗 100 灵石<br>**Then** 仓库剩余 900 灵石，数值精确无误 |
| RQ-006 | P0-A | 宗门管理系统 | **弟子管理** | 管理弟子的招募、培养、分配和晋升 | 无 | **Given** 宗门有空余名额<br>**When** 执行招募操作<br>**Then** 新弟子实体创建成功，包含完整的属性组件 |
| **RQ-007** | **P0-A** | **成长系统** | **修为提升** | 实现角色境界的提升机制 | 无 | **Given** 炼气期巅峰角色<br>**When** 修为值达到阈值并执行突破<br>**Then** 境界提升至筑基期初期，属性相应增长 |
| **RQ-008** | **P0-B** | 玩家交互系统 | **角色模式选择** | 支持掌门、长老、弟子和观察者四种游戏模式 | 无 | **Given** 主菜单界面<br>**When** 玩家选择任意模式<br>**Then** 游戏以对应模式启动，权限正确设置 |
| RQ-009 | P0-B | 玩家交互系统 | 快捷键支持 | 提供常用功能的数字快捷键 | RQ-001 | **Given** 任意菜单界面<br>**When** 按下数字键 1-9<br>**Then** 对应菜单项被选中并执行 |
| RQ-010 | P0-B | 玩家交互系统 | 事件日志 | 记录游戏事件和操作结果，支持按类型筛选 | 无 | **Given** 游戏运行 10 分钟<br>**When** 查看事件日志<br>**Then** 日志包含所有关键事件，支持按类型筛选 |
| RQ-011 | P0-B | 玩家交互系统 | 菜单系统 | 提供分层级的操作菜单，支持快捷操作 | 无 | **Given** 任意菜单层级<br>**When** 执行菜单操作<br>**Then** 菜单层级不超过 3 层，支持快速返回 |
| **RQ-012** | **P0-B** | **AI角色系统** | **自主决策** | AI角色能够根据环境和目标进行自主决策 | RQ-004 | **Given** 一个空闲状态的弟子<br>**When** 游戏时间推进 1 个时辰<br>**Then** 弟子选择并执行一个合理行为（修炼/工作/休息） |
| RQ-013 | P0-B | AI角色系统 | 行为执行 | AI角色能够执行各种行为，如修炼、工作、社交等 | RQ-012 | **Given** 弟子选择修炼行为<br>**When** 行为执行完成<br>**Then** 修为值增加，状态正确更新 |
| RQ-014 | P0-B | 宗门管理系统 | **设施管理** | 管理宗门设施的建设、维护和升级 | RQ-005 | **Given** 足够的资源<br>**When** 建设新设施<br>**Then** 设施实体创建成功，资源正确扣除 |
| **RQ-015** | **P0-B** | **战斗系统** | **基础战斗机制** | 实现文字描述的回合制战斗 | 无 | **Given** 两个战斗实体<br>**When** 执行战斗流程<br>**Then** 战斗日志完整，伤害计算正确，战斗在 100 回合内结束 |
| RQ-016 | P0-B | 战斗系统 | 战斗结算 | 处理战斗结果，分配奖励或惩罚 | RQ-015 | **Given** 战斗结束<br>**When** 执行结算<br>**Then** 胜者获得奖励，败者状态正确更新 |
| **RQ-017** | **P0-B** | **经济系统** | **双货币体系** | 实现灵石和贡献点的管理 | 无 | **Given** 角色获得 100 灵石<br>**When** 货币系统处理<br>**Then** 灵石余额正确增加，贡献点独立计算 |
| RQ-018 | P0-B | 经济系统 | 资源交易 | 支持与其他宗门进行资源交易 | RQ-017 | **Given** 足够的灵石<br>**When** 执行交易操作<br>**Then** 资源正确交换，货币正确扣除 |
| **RQ-019** | **P0-B** | **地图系统** | **区域管理** | 管理游戏世界的区域划分和状态 | 无 | **Given** 游戏世界初始化<br>**When** 查询区域信息<br>**Then** 返回正确的区域列表和状态 |
| RQ-020 | P0-B | 地图系统 | **区域占领** | 支持占领和控制游戏世界中的不同区域 | RQ-019 | **Given** 未占领的区域<br>**When** 派遣弟子占领<br>**Then** 区域控制度逐步提升，达到 100% 时完全占领 |
| **RQ-021** | **P0-B** | **设施系统** | **设施建设** | 支持建设各种宗门设施 | RQ-005 | **Given** 足够资源和空地<br>**When** 建设设施<br>**Then** 设施实体创建，资源扣除正确 |
| RQ-022 | P0-B | 设施系统 | **设施升级** | 支持设施升级，提升功能和效率 | RQ-021 | **Given** 等级 1 的设施<br>**When** 执行升级<br>**Then** 设施等级提升，效率增加 10-20% |
| **RQ-023** | **P0-B** | **功法系统** | **功法学习** | 支持角色学习和修炼功法 | RQ-007 | **Given** 符合条件的弟子和功法<br>**When** 学习功法<br>**Then** 功法添加到弟子技能列表，熟练度初始化为 0 |
| **RQ-024** | **P1** | **道具系统** | **道具分类管理** | 实现丹药、材料、装备等道具的分类管理 | 无 | **Given** 道具系统初始化<br>**When** 创建道具实体<br>**Then** 道具正确分类，属性完整 |
| RQ-025 | P1 | 道具系统 | 道具使用 | 支持角色使用各种道具 | RQ-024 | **Given** 角色拥有道具<br>**When** 使用道具<br>**Then** 道具效果生效，数量减少 |
| RQ-026 | P1 | 道具系统 | 道具炼制 | 支持炼制各种丹药和装备 | RQ-024 | **Given** 足够材料和配方<br>**When** 执行炼制<br>**Then** 产出对应道具，成功率符合设定 |
| **RQ-027** | **P1** | **社交系统** | **师徒关系** | 支持弟子拜入门下，建立师徒关系 | 无 | **Given** 符合条件的师徒<br>**When** 建立关系<br>**Then** 关系组件正确创建，双方可查询 |
| RQ-028 | P1 | 社交系统 | 同门关系 | 支持弟子之间的同门交流和互动 | 无 | **Given** 同一宗门的弟子<br>**When** 执行社交行为<br>**Then** 关系值正确变化 |
| RQ-029 | P1 | 社交系统 | 外交关系 | 支持与其他宗门建立外交关系 | 无 | **Given** 两个宗门<br>**When** 建立外交关系<br>**Then** 关系状态正确设置 |
| **RQ-030** | **P1** | **试炼系统** | **试炼参与** | 支持角色参与各种试炼活动 | 无 | **Given** 符合条件的弟子<br>**When** 参与试炼<br>**Then** 试炼流程正确执行，结果合理 |
| RQ-031 | P1 | 试炼系统 | 试炼奖励 | 处理试炼奖励的分配 | RQ-030 | **Given** 试炼完成<br>**When** 发放奖励<br>**Then** 奖励正确分配给参与者 |
| **RQ-032** | **P1** | **事件系统** | **随机事件** | 生成各种随机事件，影响游戏进程 | 无 | **Given** 游戏运行中<br>**When** 触发条件满足<br>**Then** 事件正确生成并执行 |
| RQ-033 | P1 | 事件系统 | 剧情事件 | 推动游戏剧情发展的关键事件 | 无 | **Given** 特定条件达成<br>**When** 触发剧情事件<br>**Then** 剧情正确推进，状态正确更新 |
| **RQ-034** | **P1** | **时间系统** | **时间流逝** | 游戏世界随时间发展，影响角色和宗门 | 无 | **Given** 游戏运行中<br>**When** 时间推进 1 年<br>**Then** 所有角色年龄增加 1，季节正确轮换 |
| RQ-035 | P1 | 时间系统 | 季节变化 | 不同季节对资源产出和事件有影响 | RQ-034 | **Given** 季节变化<br>**When** 进入新季节<br>**Then** 资源产出率正确调整 |
| **RQ-036** | **P2** | **任务系统** | **任务管理** | 支持生成、接受和完成各种任务 | 无 | **Given** 任务系统初始化<br>**When** 生成任务<br>**Then** 任务实体创建，条件清晰 |
| RQ-037 | P2 | 任务系统 | 任务奖励 | 处理任务完成后的奖励分配 | RQ-036 | **Given** 任务完成<br>**When** 领取奖励<br>**Then** 奖励正确发放 |
| **RQ-038** | **P2** | **成就系统** | **成就解锁** | 支持解锁各种游戏成就 | 无 | **Given** 成就条件达成<br>**When** 检查成就<br>**Then** 成功解锁并通知玩家 |
| RQ-039 | P2 | 成就系统 | 成就奖励 | 处理成就解锁后的奖励分配 | RQ-038 | **Given** 成就解锁<br>**When** 领取奖励<br>**Then** 奖励正确发放 |
| **RQ-040** | **P2** | **外交系统** | **联盟建立** | 支持与其他宗门建立联盟 | RQ-029 | **Given** 友好关系的宗门<br>**When** 建立联盟<br>**Then** 联盟关系正确建立 |
| RQ-041 | P2 | 外交系统 | 宣战机制 | 支持向其他宗门宣战 | RQ-029 | **Given** 敌对关系的宗门<br>**When** 宣战<br>**Then** 战争状态正确设置 |
| **RQ-042** | **P2** | **统计系统** | **数据统计** | 统计游戏中的各种数据，如宗门发展、弟子成长等 | 无 | **Given** 游戏运行数据<br>**When** 查询统计<br>**Then** 返回准确的统计数据 |
| RQ-043 | P2 | 统计系统 | 数据分析 | 对统计数据进行分析，提供发展建议 | RQ-042 | **Given** 统计数据<br>**When** 执行分析<br>**Then** 生成包含至少 3 条建议的分析报告 |
...
**注**：角色属性体系的详细设计请参考独立文档 [《修仙核心玩法设计》](../design/sect_cultivation_core_gameplay.md)，该文档包含完整的属性体系设计，包括境界、突破和属性系统等核心内容。

#### 3.1.3 界面设计体系

**注**：游戏界面设计的详细内容请参考以下文档：

**界面设计索引**：[设计文档索引](../design/index.md)

**具体页面设计**：
- [宗门总览页面](../design/pages/宗门总览页面布局设计.md)：宗门核心信息展示
- [弟子管理页面](../design/pages/弟子管理页面布局设计.md)：弟子列表、详情、培养
- [资源管理页面](../design/pages/资源管理页面布局设计.md)：资源查看与分配
- [设施建设页面](../design/pages/设施建设页面布局设计.md)：设施建设与升级
- [地图探索页面](../design/pages/地图探索页面布局设计.md)：区域探索与占领
- [任务大厅页面](../design/pages/任务大厅页面布局设计.md)：任务接取与完成
- [功法堂页面](../design/pages/功法堂页面布局设计.md)：功法学习与传承
- [炼丹房页面](../design/pages/炼丹房页面布局设计.md)：丹药炼制
- [炼器房页面](../design/pages/炼器房页面布局设计.md)：装备打造
- [社交页面](../design/pages/社交页面布局设计.md)：角色关系管理
- [设置页面](../design/pages/设置页面布局设计.md)：系统设置
...
| 属性名称 | 作用说明 | 数值范围 | 影响因素 |
|---------|---------|---------|---------|
| **境界** | 角色的核心实力等级 | 炼气→筑基→金丹→元婴→化神→渡劫→成仙 | 修炼、丹药、功法 |
| **境界阶段** | 每个境界内的细分阶段 | 初期→中期→后期→巅峰 | 修炼时间、资源投入 |
| **年龄** | 角色年龄 | 0-500岁 | 时间流逝 |
| **性别** | 角色性别 | 男/女 | 随机生成 |
| **气血** | 角色的健康状态 | 100-10000+ | 境界、体质属性 |
| **灵力** | 角色可用的灵气总量 | 100-5000+ | 境界、根骨属性 |
...
| 设施类型 | 数量 | 核心功能 | 建设要求 |
|---------|-----|---------|---------|
| **核心设施** | 1个 | 宗门总部，象征宗门地位 | 宗门创立时自动生成 |
| **功能性设施** | 多个 | 修炼室、炼丹房、炼器阁、藏经阁等 | 随宗门发展逐步建设 |
| **生产性设施** | 多个 | 农田、矿场、灵田等 | 随宗门发展逐步建设 |
| **防御性设施** | 多个 | 护山大阵、哨塔、地牢等 | 随宗门发展逐步建设 |
| **生活性设施** | 多个 | 弟子居、伙房、医馆等 | 随宗门发展逐步建设 |
...
| **功法类** | **修炼功法** | 提升境界 | 普通-史诗 | 学习/传承/试炼 | 100-8000 | 修为限制 |
...
| **Facility** | 设施标签组件 | `class Facility : Component()` |
| **FacilityType** | 设施类型信息 | `class FacilityType(val type: FacilityType) : Component()` |
| **FacilityEfficiency** | 设施效率信息 | `class FacilityEfficiency(var value: Double) : Component()` |
...
- **场景描绘**：使用ASCII艺术简单描绘场景，如山峰、设施、树木等
...
| **第2周** | **基础框架搭建** | 搭建ECS框架和基础游戏循环 | 1. 集成lko-ecs框架<br>2. 实现World、Entity、Component等核心类<br>3. 实现基础的Service和Query机制<br>4. 实现游戏主循环<br>5. 实现配置管理和日志系统 | 1. 可运行的基础ECS框架<br>2. 游戏主循环实现<br>3. 配置管理和日志系统<br>4. 基础测试用例 | 1. 能够创建和管理游戏实体<br>2. 系统能够按照预期执行更新<br>3. 配置和日志功能正常工作<br>4. 基础测试用例通过 |
...
> **术语使用规范**：本文档统一使用以下术语，避免同义词混用导致理解偏差。

| 术语 | 解释 | 同义词（已弃用） |
|-----|------|----------------|
| **ECS** | Entity Component System，实体组件系统，一种游戏架构模式 | - |
| **lko-ecs** | 本项目使用的自研 ECS 框架 | ~~lko-ecs4~~ |
| **宗门** | 游戏中的玩家所属组织，类似于门派或家族 | 门派 |
| **弟子** | 宗门成员，包括外门弟子、内门弟子、亲传弟子等 | 角色（泛指时使用"角色"） |
| **角色** | 游戏中的所有实体，包括弟子、长老、掌门、NPC 等 | - |
| **境界** | 角色的修炼等级，从低到高依次为：炼气→筑基→金丹→元婴→化神→渡劫→成仙 | ~~修为境界~~ |
| **境界阶段** | 每个境界内的细分阶段：初期→中期→后期→巅峰 | ~~境界层次~~ |
| **修为** | 角色的修炼进度值，用于衡量境界提升的进度 | - |
| **突破** | 角色从当前境界提升到更高境界的过程 | - |
| **灵气** | 角色修炼和施展功法所需的能量 | - |
| **设施** | 宗门内的功能性建筑，如修炼室、炼丹房、藏经阁等 | - |
| **功法** | 角色修炼和战斗的技能，分为修炼功法和战斗功法 | 技能（功法是技能的一种） |
| **试炼** | 玩家或AI角色参与的挑战活动，用于获取高级资源和功法 | - |
| **秘境** | 特殊的游戏区域，通常包含高级资源和试炼 | - |
| **炼丹** | 通过特定设施和材料制作丹药的行为 | - |
| **炼器** | 通过特定设施和材料制作装备的行为 | - |
| **灵石** | 游戏世界通用货币，用于外部交易、高级资源购买等 | - |
| **贡献点** | 宗门内部专用货币，用于内部资源分配、设施使用等 | - |
| **区域** | 游戏世界的地理划分，包括大区域和小区域 | - |
| **P0-A** | MVP 核心功能，必须在第一版发布时完成 | - |
| **P0-B** | 重要功能，可在后续迭代中完成 | - |
| **P1** | 次要功能，提升游戏体验 | - |
| **P2** | 扩展功能，增强游戏深度 | - |
...
| 1 | 掌门 | 1人 | 全宗事务决策 |
| 2 | 长老 | 2-7人 | 专项事务管理 |
| 3 | 亲传弟子 | 10-30人 | 重要任务执行 |
| 4 | 内门弟子 | 50-200人 | 基础管理和修炼 |
| 5 | 外门弟子 | 200-1000人 | 完成基础任务 |
| 6 | 宗门杂役 | 500-5000人 | 提供劳动力 |
| 7 | 凡俗百姓 | 10000+人 | 提供基础资源产出 |
...
本项目强制使用 **测试驱动开发（TDD）** 模式。所有功能开发必须遵循 **红-绿-重构** 循环：

1. **🔴 红 (Red)**: 编写失败的测试 → 运行测试 → 确认失败
2. **🟢 绿 (Green)**: 编写最小实现 → 确认测试通过
...
**验收标准**:
- 所有测试通过：`./gradlew test`
- 核心逻辑覆盖率 > 80%：`./gradlew allCoverage`
- 无 Lint 警告
...
| 版本 | 日期 | 修改内容 | 修改人 |
|-----|------|---------|-------|
| v1.2 | 2026-02-19 | 1. 统一术语：\"设施\"替代\"建筑\"<br>2. 统一术语：\"境界\"替代\"修为境界\"<br>3. 统一术语：\"境界阶段\"替代\"境界层次\"<br>4. 修正表格编号（表1-表8连续）<br>5. 统一ECS组件命名（Facility替代Building）<br>6. 扩展术语表（新增突破、灵气、秘境、炼丹、炼器等）<br>7. 新增弟子层级与数量规范表 | AI Assistant |
| v1.1 | 2026-02-18 | 1. 修正文档引用路径<br>2. 统一技术架构描述（lko-ecs）<br>3. 细分 P0 为 P0-A/P0-B<br>4. 添加 Given-When-Then 验收标准<br>5. 扩展术语表并统一术语<br>6. 添加 TDD 测试要求 | AI Assistant |
